...
import org.jetbrains.kotlin.fir.analysis.diagnostics.jvm.FirJvmErrors.CONFLICTING_JVM_NAME_AND_EXPOSE
...
import org.jetbrains.kotlin.fir.analysis.diagnostics.jvm.FirJvmErrors.INAPPLICABLE_JVM_EXPOSE
...
object FirJvmErrorsDefaultMessages : BaseDiagnosticRendererFactory() {
    ...
    override val MAP = KtDiagnosticFactoryToRendererMap("FIR").also { map ->
        ...
        map.put(INAPPLICABLE_JVM_EXPOSE, "'@JvmExpose' annotation is not applicable to this declaration")
        map.put(CONFLICTING_JVM_NAME_AND_EXPOSE, "'@JvmExpose' and '@JvmName' can't be applied to a declaration simultaneously")
